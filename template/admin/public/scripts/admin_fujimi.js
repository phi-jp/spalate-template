      ...
      edit: [
        {
          ...
          items: [
            ...
            { label: '詳細',  type: 'multitext', key: 'data.description', class: 'col12' },
            { label: '形状',  type: 'select', key: 'data.shape', class: 'col4', options: [
              { label: 'ハードカプセル', value: 'hard' },
              { label: 'ソフトカプセル', value: 'soft' },
            ...
            { label: '成分一覧',  type: 'select-collection', key: 'data.ingredients', class: 'col12', options: {
              collection: 'ingredients',
              key: 'name',
            } },
